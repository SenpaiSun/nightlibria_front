  ...
  return (
    <div>
      <CarouselComponent title={'Последние релизы:'}>
        <CarouselSlide data={lastRelease} path={'lastRelease'} />
      </CarouselComponent>
